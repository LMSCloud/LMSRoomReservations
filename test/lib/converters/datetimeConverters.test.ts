...
describe("convertToSimpleDatetime", () => {
    it("outputs YYYY-MM-DDTHH:mm format", () => {
        const result = convertToSimpleDatetime("2024-06-15T14:30:45");
        expect(result).toBe("2024-06-15T14:30");
    });

    it("handles full ISO strings", () => {
        const result = convertToSimpleDatetime("2024-01-01T00:00:00.000Z");
