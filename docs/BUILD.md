...
The full build (sync Util modules, format code, generate CSS, bundle JS, package `.kpz`):
...
The output is a file named `lms-room-reservations-<version>.kpz` in the project root.
