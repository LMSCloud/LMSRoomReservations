...
Koha/Plugin/Com/LMSCloud/RoomReservations/Util/   # generated output (committed)
    I18N.pm            # package ...::RoomReservations::Util::I18N
    MigrationHelper.pm # package ...::RoomReservations::Util::MigrationHelper
    Pages.pm           # package ...::RoomReservations::Util::Pages
```
...
git add vendor/koha-plugin-lmscloud-util Koha/Plugin/Com/LMSCloud/RoomReservations/Util/
...
5. Repeat in the other plugin repo (LMSEventManagement)
