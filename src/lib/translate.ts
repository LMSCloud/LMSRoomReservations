...
import { AttributePart, Directive, directive, PartInfo, PartType, PropertyPart } from "lit/directive.js";
...
export const localeFull = document.documentElement.lang === "en" ? "en-US" : document.documentElement.lang;

async function loadTranslations(localeUrl = "/api/v1/contrib/roomreservations/static/locales") {
...
export class TranslateAttributeDirective extends Directive {
    ...
    constructor(partInfo: PartInfo) {
        ...
        this._locale = document.documentElement.lang.slice(0, 2);
        if (partInfo.type !== PartType.PROPERTY && partInfo.type !== PartType.ATTRIBUTE) {
    ...
    override update(part: PropertyPart | AttributePart, [text]: Parameters<this["render"]>) {
