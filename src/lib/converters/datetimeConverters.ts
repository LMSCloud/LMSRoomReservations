 ...
 */
export function convertToFormat(string: string, format: string, locale: string): string {
 ...
 */
export function splitDateTime(string: string | Date | null, locale: string): string[] {
    if (!string) {
...
/**
 * Converts a datetime to simple datetime format.
 * @param string
 * @returns
 */
export function convertToSimpleDatetime(string: string): string {
    return dayjs(string).format("YYYY-MM-DDTHH:mm");
}
 ...
 */
export function formatDatetimeByLocale(datetime: string | Date | null, locale: string): TemplateResult {
    if (!datetime) {
